        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center max-w-4xl mx-auto" data-aos="fade-up">
                <div class="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md px-6 py-3 rounded-full mb-8">
                    ...
                    <span class="text-white font-semibold">Edit Konten</span>
                </div>
                ...
                <p class="text-xl text-white/90 leading-relaxed">
                    Perbarui artikel dan tulisan Anda
                </p>
            </div>
        </div>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg" data-aos="fade-up">
                ...
                <div class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg" data-aos="fade-up">
                    <div class="flex items-start">
                ...
                <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg" data-aos="fade-up">
                    <div class="flex items-start">
                ...
                <form action="{{ route('user.blog.update', $blog) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 card-hover" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <!-- Left Column - Current Images & Upload -->
                            <div class="space-y-6">
                                <!-- Current Images -->
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <img src="{{ Storage::url($blog->featured_image) }}" 
                                             ...
                                             class="current-image w-full h-32 object-cover rounded-lg">
                                    </div>
                                    @endif
                            ...
                            <div class="space-y-6">
                                <!-- Status Warning -->
                                <div id="publish-warning" class="p-4 bg-yellow-50 border border-yellow-200 rounded-lg {{ old('status', $blog->status) == 'published' ? '' : 'hidden' }}">
                                    <div class="flex items-start">
                                ...
                                <div class="bg-gray-50 rounded-lg p-4">
                                    <h4 class="text-sm font-medium text-gray-700 mb-3">Preview Gambar Baru</h4>
                                    <div class="aspect-w-16 aspect-h-9 bg-gray-200 rounded-lg flex items-center justify-center">
                                        <div id="image-preview" class="text-center p-4">
                                            ...
                                            <p class="text-xs text-gray-500">Gambar baru akan muncul di sini</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                reader.onload = function(e) {
                    fileUploadArea.innerHTML = `
                        <div class="text-center">
                            <img src="${e.target.result}" class="max-h-24 mx-auto rounded-lg mb-2" alt="Preview">
