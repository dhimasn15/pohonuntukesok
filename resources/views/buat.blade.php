    ...
    <nav class="fixed w-full bg-primary text-white shadow-md z-50 transition-all duration-300" id="main-nav">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            <a href="{{route('home')}}" class="flex items-center text-2xl font-bold hover-target">
                <i class="fas fa-tree mr-2 animate-bounce-slow"></i>
            ...
            <div class="hidden lg:flex items-center space-x-8">
                <a href="{{route('home')}}" class="hover:text-accent transition-colors flex items-center group">
                    <i class="fas fa-home mr-2 group-hover:animate-bounce"></i> Beranda
                </a>
                <div class="relative group">
                    ...
                    <div class="dropdown-menu absolute left-0 mt-2 w-56 bg-white rounded-xl shadow-xl py-2 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                        <a href="{{ route('buat')}}" class="block px-4 py-3 text-gray-800 hover:bg-green-50 hover:text-primary transition-colors rounded-lg mx-2">
                            <i class="fas fa-plus-circle text-primary mr-2"></i>Buat Kampanye
                        </a>
                        <div class="border-t my-1"></div>
                        <a href="{{ route('donasi')}}" class="block px-4 py-3 text-gray-800 hover:bg-green-50 hover:text-primary transition-colors rounded-lg mx-2">
                            <i class="fas fa-hand-holding-heart text-primary mr-2"></i>Donasi Pohon
                        </a>
                        <div class="border-t my-1"></div>
                        <a href="#" class="block px-4 py-3 text-gray-800 hover:bg-green-50 hover:text-primary transition-colors rounded-lg mx-2">
                ...
                <a href="{{ route('about')}}" class="hover:text-accent transition-colors flex items-center group">
                    <i class="fas fa-info-circle mr-2 group-hover:animate-bounce"></i> Tentang Kami
                </a>
                <a href="{{ route('blog')}}" class="hover:text-accent transition-colors flex items-center group">
                    <i class="fas fa-newspaper mr-2 group-hover:animate-bounce"></i> Blog
                </a>
                <div class="flex space-x-4 ml-8">
                    <a href="#" class="px-4 py-2 border border-white rounded-lg hover:bg-white hover:text-primary transition-colors ripple-btn">
                        <i class="fas fa-sign-in-alt mr-2"></i> Masuk
                    </a>
                    <a href="#" class="px-4 py-2 bg-white text-primary font-bold rounded-lg hover:bg-gray-100 transition-colors shimmer-btn">
            ...
            <div class="container mx-auto px-4 h-full overflow-y-auto pt-20 pb-8">
                <div class="flex flex-col items-center space-y-6 text-xl font-semibold text-white">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 w-full sm:justify-center pt-4">
                        <a href="#" class="px-6 py-3 border border-white rounded-lg hover:bg-white hover:text-primary transition-colors text-center ripple-btn">
                            <i class="fas fa-sign-in-alt mr-2"></i> Masuk
                        </a>
                        <a href="#" class="px-6 py-3 bg-white text-primary font-bold rounded-lg hover:bg-gray-100 transition-colors text-center shimmer-btn">
                            <i class="fas fa-user-plus mr-2"></i> Daftar
                        </a>
                    </div>
                </div>
